...
void loop() {
    ...
    { 
        ...
        client.println("<link rel='stylesheet' type='text/css' href='https://cdn.rawgit.com/sonnynho9/Arduino/Temperatura/Temperatura/style.css' />");
        client.println("</head)");
        client.println("<body>");
        client.println("<body bgcolor='#00FFFF'/>");
        client.println("</body>");
        client.println("</html>");
}
